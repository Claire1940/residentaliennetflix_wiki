      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Resident Alien Netflix Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@residentaliennetflix.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@residentaliennetflix.wiki</a>
            </p>
            <p>
