...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Resident Alien Netflix Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Resident Alien Netflix Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Resident Alien Netflix Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      description: 'Learn about our mission to provide the best Resident Alien Netflix game resources and guides.',
      images: [
        {
    ...
    twitter: {
      ...
      title: 'About Resident Alien Netflix Wiki',
      description: 'Learn about our mission to provide the best Resident Alien Netflix game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Resident Alien Netflix
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Resident Alien Netflix Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "Resident Alien Netflix". We are a community-driven platform that provides comprehensive guides,
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Resident Alien Netflix players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Resident Alien Netflix Wiki as the <strong>go-to destination</strong> for every Resident Alien Netflix player seeking
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Resident Alien Netflix Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Resident Alien Netflix as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Resident Alien Netflix mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              ...
              endorsed by, or associated with the developers of Resident Alien Netflix or any official entities.
            </p>
            <p>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Resident Alien Netflix news.
