...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Resident Alien Netflix Wiki",
      description: "Terms and conditions for using Resident Alien Netflix Wiki.",
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Resident Alien Netflix Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Resident Alien Netflix Wiki.
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Resident Alien Netflix Wiki and are protected by international
            ...
            <p>
              ...
              you and Resident Alien Netflix Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@residentaliennetflix.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@residentaliennetflix.wiki</a>
            </p>
            <p>
